public class BalaFresa {
  ...
  public BalaFresa() {
    posX=0; //posicion inicial igual a la del enemigo fresa en X para que salga desde el.
   posY=0;  //posicion inicial igual a la del enemigo fresa en Y para que salga desde el.
    bala=loadImage("fresa bala.png"); // cargar la imagen de la bala fresa
