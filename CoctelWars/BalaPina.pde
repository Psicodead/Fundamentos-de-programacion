public class BalaPina {
  ...
  public BalaPina() {
    posX=0; //posicion inicial igual a la del enemigo pina en X para que salga desde el.
   posY=0;  //posicion inicial igual a la del enemigo pina en Y para que salga desde el.
    bala=loadImage("bala pina.png"); // cargar la imagen de la bala pina
